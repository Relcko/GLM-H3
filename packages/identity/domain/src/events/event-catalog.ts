...
export const EventCatalog = {
  ...
  ORGANIZATION_RENAMED: 'identity.organization.renamed',
  ORGANIZATION_DESCRIPTION_UPDATED: 'identity.organization.description.updated',
  ORGANIZATION_DISPLAY_NAME_UPDATED: 'identity.organization.display_name.updated',
  ORGANIZATION_ACTIVATED: 'identity.organization.activated',
  ORGANIZATION_DEACTIVATED: 'identity.organization.deactivated',
  ORGANIZATION_DELETED: 'identity.organization.deleted',
  ORGANIZATION_ARCHIVED: 'identity.organization.archived',
  ORGANIZATION_RESTORED: 'identity.organization.restored',
