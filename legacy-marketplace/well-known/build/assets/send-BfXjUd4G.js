import{d2 as x,d5 as d,dp as u,d6 as b,d7 as v,d9 as F,cV as D,cT as w,cO as j,dW as l,d8 as c,db as z,cM as h,cJ as H,dc as E,dI as L,cN as y,cZ as J,cY as Q,dm as M,d3 as q,d4 as K,de as G,ej as Z,ek as X,cP as ee,cQ as te}from"./app-A5SVLKDt.js";import"./index-CysoWtIx.js";import"./index-CkLemSVZ.js";import{S as Y}from"./SwapController-B52gdyuf.js";/* empty css            */const ie=x`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let N=class extends v{constructor(){super(...arguments),this.params=h.state.data?.send}render(){return c` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(t){t&&!this.params&&h.push("Networks",{network:t})}};N.styles=le;B([d()],N.prototype,"receiverAddress",void 0);B([d({type:Object})],N.prototype,"caipNetwork",void 0);B([u()],N.prototype,"params",void 0);N=B([b("w3m-wallet-send-details")],N);const ce=x`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
